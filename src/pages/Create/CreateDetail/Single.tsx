  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row' }}>
      <Around style={{ width: '516px' }}>
        ...
        <h2>Upload file</h2>
        <div style={{ width: '460px', height: '140px', padding: '32px 60px 32px 60px', border: '1px dashed lightgray', borderRadius: '16px' }}>
          <FormGroup>
        ...
        <div>
          ...
          <div>
            ...
            <div className="form__group field">
              <input type="input" className="form__field" placeholder="Digital key, code to redeem or link to a file ..." name="name" id='name' />
            </div>
